...
def PortEvergladesLBPost(container, path):
    ...
    postJson["city"] = "Fort Lauderdale" #mandatory
    postJson["country"] = "US" #mandatory
    postJson["state"] = "FL"
    postJson["location"] = "1850 Eller Dr, Fort Lauderdale, FL 33316"
    postJson["latitude"] = 26.09
    postJson["longitude"] = -80.12
    postJson["terminalCode"] = "PortEverglades"

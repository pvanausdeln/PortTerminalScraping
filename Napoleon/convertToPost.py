...
def PortEvergladesLBPost(container, path):
    ...
    postJson["resolvedEventSource"] = "Napoleon RPA"
    postJson["codeType"] = "UNLOCODE"
    postJson["city"] = "New Orleans" #mandatory
    postJson["country"] = "US" #mandatory
    postJson["state"] = "LA"
    postJson["location"] = "1350 Port of New Orleans Pl, New Orleans, LA 70130"
    postJson["latitude"] = 29.94
    postJson["longitude"] = -90.06
    postJson["terminalCode"] = "Napoleon"
...
def main(containerList, cwd):
    ...
    for container in containerList:
        PortEvergladesLBPost(container, path)

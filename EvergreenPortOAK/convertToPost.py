...
def EverportPost(step):
    ...
    postJson["address"] = "7th St, Oakland, CA 94607"
    postJson["country"] = "US"
    postJson["state"] = "CA"
...
def main(containerList):
    for container in containerList:
        fileList = glob.glob(r"C:\\Users\\pvanausdeln\\Dropbox (Blume Global)\\Documents\\UiPath\\PortTerminalScraping\\EvergreenPortOAK\\ContainerInformation\\"+container+'Step*.json', recursive = True) #get all the json steps
        if (not fileList):
            continue
